...
/**
 * Clone of the org.matheclipse.core.eval.MathMLUtilities with a little
 * modification in the toMathML method. This modification is to avoid some code
 * that MathEclipse includes in the MathML code
 * 
 */
public class MathMLWriter {
	...
	public MathMLWriter(final EvalEngine evalEngine, final boolean msie) {
	 ...
	 * @param out
	 */
	synchronized public void toMathML(final String inputExpression,
			final Writer out) {
	 ...
	 * @param out
	 */
	synchronized public void toMathML(final IExpr objectExpression,
			final Writer out) {
	...
	synchronized public void toJava(final String inputExpression,
			final Writer out) {
		IExpr parsedExpression = null;
		ASTNode node;
		if (inputExpression != null) {

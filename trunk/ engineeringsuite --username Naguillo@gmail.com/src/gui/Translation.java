...
public class Translation {
	...
	/* 60 */Language
			.add("Por defecto Levenberg-Marquardt");
	...
	Language
			.add("eSuite puede trabajar con estas funciones: Sin, Cos, Tan, ArcSin, ArcTan, ArcCos, Sinh, Cosh, Tanh, Log, Ln (que es igual a log), Exp. Además, incorpora una constante: Pi.\n\n");
	...
	Language.add("A diferencia de eSuite Solver cos, exp, sinh,... deben estar seguidos de corchetes.\n\n");
	/* 345 */Language
	...
	Language
		...
		/* 0 */
			...
			/* 60 */Language
					.add("By default Levenberg-Marquardt");
			...
			Language
					.add("The methods GN, DD, HM, will limit their maximum step to the one specified here");
			...
			Language.add("Rendered Equations");
			...
			Language.add("Create a new document erasing the present one");
			/* 145 */Language
					.add("<html><body leftmargin=0 topmargin=6 marginwidth=5 marginheight=6>Pdf</body></html>");
			...
			Language.add("Numerical integration:");
			Language.add("Determinant of a matrix:");
			...
			Language
					.add("The only limitation for the number of equations are the RAM memory and the complexity of the equations.\n\n");
			Language
					.add("The search field works in one direction starting from the actual caret position.\n\n");
			/* 215 */Language
					.add("The saved file is a plain text file which can be open with notepad, gedit, etc.\n\n");
			Language
			...
			Language
					.add("Maybe your equations fell in a point where the Jacobian matrix become singular therefore it's not your fault."
			...
			Language
					.add("This section shows how was the calculation and also shows the count appearance of the variables.\n");
			/* 250 */Language
					.add("The first section, the count, is useful when the error window Number of equations and variables do not match. For counting the appearance of variables and then see if you made a typo with a variable.\n");
			Language
			...
			Language
					.add("From here you can see the result of the equations. The variables are shown in alphabetical order"
							+ " and they are wrote differently depending of their value:\n\n");
			...
			Language
					.add("This for numbers between small numbers and big numbers. The codification is this: 12345.1234567.\n\n");
			Language
			...
			Language
					.add("There are no row or column limits to write.However if you print or export to PDF the equations and there are one or more lines which equations are too long then they will be cut and "
			...
			Language
					.add("eSuite can handle all these functions: Sin, Cos, Tan, ArcSin, ArcTan, ArcCos, Sinh, Cosh, Tanh, Log, Ln (which is the same to Log), Exp. And also has one constant: Pi.\n\n");
			...
			Language
					.add("Themes: There are four themes. The program has been designed to use the nimbus theme, and the default theme is nimbus. However if you want the program to be more integrated with your system, select system theme"
							+ ". This theme is the same of your operating system.\n\n");
			Language.add("2) Equations\n\n");
			/* 285 */Language
					.add("Precision: this sets stop criteria for the algorithms. Lower values means higher precision but more time to accomplish the calculations. The stop criteria is the difference between two steps: if precision < ((Xnew-Xold)/(Xnew)) the stop.\n\n");
			Language
					.add("Number of iterations: If the solution can't be reach the algorithm must stop by other criteria. Number of iteration mean how many tries do you want to perform before stopping the algorithm. 200 is a good value. It is very difficult that you need a higher value.\n\n");
			Language
			...
			Language
					.add("The initial value is crucial in the resolution of equations with numerical algorithms. Because this methods only will find one solution. For example in the equation x^2=1 there are two solutions:\n"
							+ "x = -1 and x= 1.\nSo if the initial point is set in 2 the result will be 1 but if the initial point is set in -2 the result will be -1.\nThis is only one reason but there are many more important than that. If the algorithm starts too far from the solution maybe the algorithm won't be able to reach a solution due to, for example, the equation has too many maximums on the way "
			...
			/* 300 */Language
					.add("This changes the initial value for all the variables.\n\n");
			Language.add("2) Save last value as initial point\n");
			Language
					.add("This will make next solve process to be calculated faster. Also this may improve the capabilities of the algorithm because if we add new equations but the last calculated value was good then the new value should be near of the last. By default disabled.\n\n");
			...
			/* 310 */Language
					.add("Cos(x) + 4 * X = 0\nAs you can see it does not matter that the X is in upper and smaller case\n\n");
			Language.add("Example Nº 2\n\n");
			Language
					.add("Log[x) / Log(10) = 1\nX=10 is the result. This is the way for making different logarithms. Also you can see that the use of claps or parenthesis doesn't matter.\n\n");
			Language.add("Example Nº 3\n\n");
			Language
					.add("2 * x + y = 1\nx * y = 3\na + b = x\n3 * a * b = 6\nHere you can appreciate that there are four equations that can be solved as a one 4 x 4 equation system or as two 2 x 2 equation system if the first equation system is the [x,y] system. This is what eSuite does. Splits the equation system into subsystems.\n\n");
			/* 315 */Language.add("Example Nº 4\n\n");
			Language
					.add("1 / (x - 1) = 2\nIf you try to solve this equation (and you have changed nothing on initial values) you will find that eSuite gives you a problem. That's because the initial point is 1 and the result of evaluating that equation in one is infinitum.You can try setting the initial point to 2 and using Line-Search and it will be solved.However if you try a negative number, or smaller than 1 possibly the equation won't be solved.\n\n");
			Language.add("Example Nº 5\n\n");
			Language
					.add("These equations are solved one by one:\nF = m * a ^ 2\nm = 3,4 * a\na = 2.3 \n\n");
			Language.add("Algorithms\n\n\n");
			...
			Language
					.add("These kind of algorithms are globally convergent and for explain how they work let see and example:\n\n");
			...
			Language
					.add("These steps are repeated until the solution is found\n\n");
			Language.add("Mathematics\n\n\n");
			Language.add("Characteristics: \n\n");
			Language
			...
			Language
					.add("Internally the program translates the functions to upper case, that is why it fails introducing one the result in capital letters.\n\n");
			Language
					.add("The rendered print can't be copied to the clipboard.\n\n");
			Language
					.add("Commands and examples can be seen in the program by typing help or quickhelp.\n\n");
			Language
			...
			Language.add("Thermodynamic formulas");
			Language
					.add("From this menu you can add material properties to your equations or you can create and store more formulae.");
			Language.add("Recommendations: ");
			Language
					.add("Use the name of the variable instead a letter. I.E: Temperature instead of T.");
			/* 370 */Language
					.add("Formulae must be added in an equation form. I.E: Pressure * Volume = mol * R * Temperature.");
			Language
			...
			Language
					.add("Property not found: You have called to a thermodynamic substance ( Substance.Property(var1,var2) ) however you have fail writting the property.\n\n");
			/* 375 */Language.add("What do you want to include in the queue?");
			Language.add("Everything");
			Language
					.add("if you are going to calculate the temperature or presion from an enthalpy, entropy, Cp, etc. equation probably the variable will need an initial guess.");
			...
			Language.add("The following variables have reached a complex value");
			Language

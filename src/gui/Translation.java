...
public class Translation {
	...
	public Translation() {
		...
		if (Config.Language.equalsIgnoreCase("Español")) {
			...
			/* 35 */Language
					.add("Vaya a https://code.google.com/p/engineeringsuite/ para más información");
		...
		/* 0 */
			...
			/* 35 */Language.add("See https://code.google.com/p/engineeringsuite/ for more information");

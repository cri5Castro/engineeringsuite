...
public class PrepareUncmin {
	 ...
	 * @param Functions
	 * @return MAximum residual of the input equations
	 */
	public static double getMaxResidual(LinkedList<Integer> Functions){
		double aux = 0.0;
		
		for (int i = 0; i < Functions.size(); i++) {
			aux = Math.max(aux, Math.abs(DiffAndEvaluator.Evaluate
					("N[" + CheckString.Functions.get(Functions.get(i)).getEquation() + "]")));
		}
	 ...
	 * @return MAximum residual of the input equations
	 */
	public static double getMaxResidual(String function){
		double aux = Math.abs(DiffAndEvaluator.Evaluate("N[" + function + "]"));
